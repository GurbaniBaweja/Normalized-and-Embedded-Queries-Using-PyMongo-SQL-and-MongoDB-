...
# Create a new collection to store the aggregated result
collecton_artist_track = db["ArtistsTracks"]
#clear this collection
collecton_artist_track.delete_many({})

collecton_artist_track.insert_many(aggregate_result)

print(collecton_artist_track.count_documents({}))

# drop the two normalized collection
collection_artists.drop()
collection_tracks.drop()
